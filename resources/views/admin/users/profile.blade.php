                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('updateProfile') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="national_number" type="national_number" class="form-control{{ $errors->has('national_number') ? ' is-invalid' : '' }}" name="national_number"  value="{{$user->national_number}}" required>
                        ...
                        <div class="form-group">
                            <div class="col-md-1 offset-md-4">
                                <a href="{{route('adminDashboard')}}" class="btn btn-warning">
                                    {{ __('Back') }}
                                </a>
                            </div>
                        </div>
