...
<div class="container-fluid">
    <div class="row">
        ...
        <br>
            ...
            @endif
                <div class="card-body">
                    <form method="POST" action="{{ route('administratorUpdate') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="text" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" name="phone"  value="{{$admin->phone}}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="national_number" type="national_number" class="form-control{{ $errors->has('national_number') ? ' is-invalid' : '' }}" name="national_number"  value="{{$admin->national_number}}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" value="{{ $admin->password }}" name="password" required>
                        ...
                        <div class="form-group">
                            <div class="col-md-1 offset-md-4">
                                <a href="{{ route('administrators') }}" class="btn btn-warning">
                                    {{ __('Back') }}
                                </a>
                            </div>
                        </div>
